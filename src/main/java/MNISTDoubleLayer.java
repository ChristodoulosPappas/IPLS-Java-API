...
public class MNISTDoubleLayer {
    public static INDArray global_model;

    static INDArray Copy(INDArray arr1,INDArray arr2){
        int i;
        for(i = 0; i < arr2.length(); i++){
            arr1.putScalar(i,arr2.getDouble(i));
        }
        return  arr1;
    }
    ...
    public static void main(String[] args){
        ...
        model.init();
        int size = 443610;
        global_model = Nd4j.zeros(1,model.params().length());
        global_model = Copy(global_model,model.params());
        Worker t1 = new Worker(global_model,1);
        //Worker t2 = new Worker(global_model,2);
        //Worker t3 = new Worker(global_model,3);
        //Worker t4 = new Worker(global_model,4);
        //Worker t5 = new Worker(global_model,5);
        //Worker t6 = new Worker(global_model,6);
        //Worker t7 = new Worker(global_model,7);
